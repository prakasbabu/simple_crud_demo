...
public class JwtTokenUtil implements Serializable{
	 private static final long serialVersionUID = -2550185165626007488L;
	    ...
	    //@Value("${jwt.secret}")
	    private String secret = "novbatche23vmvvmcvnc";
	    ...
	    private String doGenerateToken(Map<String, Object> claims, String subject, String role) {
	        return Jwts.builder().setClaims(claims).setSubject(subject).setAudience(role).setIssuedAt(new Date(System.currentTimeMillis()))
